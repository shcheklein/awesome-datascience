...
* [DVC](https://github.com/iterative/dvc) - An open-source version control system for data science projects. It provides a framework for organizing and managing data science projects, making them reproducible and shareable. In its basic scenario, DVC helps to manage and version control data files and models.
